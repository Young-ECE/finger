...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    */
    ...
    /* I2C1 DMA Disabled - Using polling mode to avoid conflicts with I2S DMA */
    /* 禁用DMA，使用轮询模式避免与I2S DMA冲突 */

    /* I2C1 interrupt Init */
    HAL_NVIC_SetPriority(I2C1_EV_IRQn, 3, 0);  // 提高优先级，高于I2S DMA
    HAL_NVIC_EnableIRQ(I2C1_EV_IRQn);
    HAL_NVIC_SetPriority(I2C1_ER_IRQn, 3, 0);  // 提高优先级，高于I2S DMA
